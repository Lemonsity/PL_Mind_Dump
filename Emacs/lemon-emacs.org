...
Emacs makes a special symlink to indicate a file is being edited by "you". This symlink is called a "lock file"
Because I am the only person using this computer, I am unlikely to run into simultaneous editing issue, so I am disabling this feature
...
- [ ] which-key hook with lsp-mode
- [ ] TeX-fold-mode on Tex startup
